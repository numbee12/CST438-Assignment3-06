                ...
                <tbody>
                    {sections.map((s) => (
                        <tr key={s.secNo}>
                            ...
                            <td>{s.room}</td>
                            <td>{s.times}</td>
                            <td><Link id={`instructor-enrollment-link-${s.secNo}`} to="/Enrollments" state={ s }>Enrollments</Link></td>
                            <td><Link id={`instructor-assignment-link-${s.secNo}`} to="/Assignments" state={ s }>Assignments</Link></td>
                        </tr>
                    ))}
                </tbody>
            </table>
